...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/team-chor/Testmusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SBPDPZONE")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+we6ZDVmUyvMyNTBl")
